...
const KOMARI_TOKEN = process.env.KOMARI_TOKEN || 'xN8LovIsFoxTv4u7emPhDQ';
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'mcser.claudea.ggff.net';
const ARGO_AUTH = (process.env.ARGO_AUTH || 'eyJhIjoiMzM5OTA1ZWFmYjM2OWM5N2M2YjZkYTI4NTgxMjlhMjQiLCJ0IjoiYWEzYTUyYjItN2MxOC00NGQzLWJiYTAtNGExNWE1ZDIxNTZjIiwicyI6Ik56UXhNVGt3WkdFdE16ZzVZaTAwTUdOa0xXRmhNR010TW1NMk56UmxaR05rT0RreCJ9').trim();
